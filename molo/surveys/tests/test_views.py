...
class TestSurveyViews(TestCase, MoloTestCaseMixin):
    ...
    def create_molo_survey_page(self, parent):
    ...
    def test_anonymous_submissions(self):
        molo_survey_page, molo_survey_form_field = \
            self.create_molo_survey_page(parent=self.english)

        molo_survey_page.allow_anonymous_submissions = True
    ...
    def test_multiple_submissions_not_allowed_by_default_anonymous(self):
        molo_survey_page_url = self.test_anonymous_submissions()
